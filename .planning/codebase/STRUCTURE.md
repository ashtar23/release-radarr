...
- Key files: [`apps/mobile/src/app/_layout.tsx`](soonr/apps/mobile/src/app/_layout.tsx), [`apps/mobile/package.json`](soonr/apps/mobile/package.json)
...
- Key files: [`apps/web/src/main.tsx`](soonr/apps/web/src/main.tsx), [`apps/web/src/router.tsx`](soonr/apps/web/src/router.tsx)
...
- Key files: [`packages/api-client/src/index.ts`](soonr/packages/api-client/src/index.ts)
...
- Key files: [`packages/types/src/index.ts`](soonr/packages/types/src/index.ts)
...
- Key files: [`packages/config/src/index.ts`](soonr/packages/config/src/index.ts)
...
- Key files: [`packages/ui/components.json`](soonr/packages/ui/components.json), [`packages/ui/src/components/button.tsx`](soonr/packages/ui/src/components/button.tsx)
...
- Key files: [`supabase/config.toml`](soonr/supabase/config.toml), [`supabase/functions/api/index.ts`](soonr/supabase/functions/api/index.ts)
...
- [`apps/mobile/src/app/_layout.tsx`](soonr/apps/mobile/src/app/_layout.tsx): Mobile app shell and provider setup
- [`apps/web/src/main.tsx`](soonr/apps/web/src/main.tsx): Web bootstrap
- [`supabase/functions/api/index.ts`](soonr/supabase/functions/api/index.ts): Backend function entry

**Configuration:**

- [`package.json`](soonr/package.json): Root scripts and engines
- [`turbo.json`](soonr/turbo.json): Task definitions
- [`pnpm-workspace.yaml`](soonr/pnpm-workspace.yaml): Workspace boundaries
- [`supabase/config.toml`](soonr/supabase/config.toml): Local Supabase services and function settings

**Core Logic:**

- [`apps/mobile/src/features/search/hooks/use-search-titles-query.ts`](soonr/apps/mobile/src/features/search/hooks/use-search-titles-query.ts): Mobile search query state
- [`apps/web/src/features/search/data-access/search-titles.ts`](soonr/apps/web/src/features/search/data-access/search-titles.ts): Web search data access
- [`supabase/functions/api/data/titles-repository.ts`](soonr/supabase/functions/api/data/titles-repository.ts): Cached title reads/writes
- [`supabase/functions/api/providers/rawg.ts`](soonr/supabase/functions/api/providers/rawg.ts): RAWG adapter

**Testing:**

- [`supabase/tests/contracts.mjs`](soonr/supabase/tests/contracts.mjs): Backend contract test suite
- No dedicated app/package unit test directories exist yet

**Documentation:**

- [`AGENTS.md`](soonr/AGENTS.md): Repo-level working guidance
- [`docs/`](soonr/docs): Product and architecture docs
- [`supabase/README.md`](soonr/supabase/README.md): Backend notes
