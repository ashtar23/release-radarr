...
**Environment:**
- Node.js >=18 - Required by the workspace root in [`package.json`](/Users/vladimirturkonja/Documents/Developer/release-radarr/package.json)
...
**Package Manager:**
- pnpm 9.0.0 - Workspace package manager defined in [`package.json`](/Users/vladimirturkonja/Documents/Developer/release-radarr/package.json)
- Lockfile: `pnpm-lock.yaml` present

## Frameworks

**Core:**
- Turborepo 2.8 - Monorepo task orchestration via [`turbo.json`](/Users/vladimirturkonja/Documents/Developer/release-radarr/turbo.json)
...
**Testing:**
- Node `assert` + native fetch - Backend contract test harness in [`supabase/tests/contracts.mjs`](/Users/vladimirturkonja/Documents/Developer/release-radarr/supabase/tests/contracts.mjs)
...
**Build:**
- [`turbo.json`](/Users/vladimirturkonja/Documents/Developer/release-radarr/turbo.json) for task graph
- [`pnpm-workspace.yaml`](/Users/vladimirturkonja/Documents/Developer/release-radarr/pnpm-workspace.yaml) for workspace membership
- Per-package `tsconfig.json` files and shared presets in `packages/typescript-config/`
- [`supabase/config.toml`](/Users/vladimirturkonja/Documents/Developer/release-radarr/supabase/config.toml) for local Supabase services and function config
