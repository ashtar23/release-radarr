...
- Examples: `createSoonrApiClient`, `searchTitles`, `getTitleDetails`
...
- Location: [`apps/mobile/src/app/_layout.tsx`](soonr/apps/mobile/src/app/_layout.tsx)
...
- Location: [`apps/web/src/main.tsx`](soonr/apps/web/src/main.tsx)
...
- Location: [`supabase/functions/api/index.ts`](soonr/supabase/functions/api/index.ts)
